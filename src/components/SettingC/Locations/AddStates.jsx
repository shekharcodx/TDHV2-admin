...
const AddStates = () => {
    ...
    const handleSubmit = (e) => {
      ...
      alert(`Selected: ${country?.name} (${country?.code}) - State: ${selectedState}`);
    };
  
    const availableStates = countriesData.find(c => c.code === selectedCountry)?.states || [];
        ...
        <div className="card mb-4">
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label htmlFor="country2" className="form-label">Select Country:</label>
                <select
                  id="country2"
              ...
              <div className="mb-3">
                <label htmlFor="state2" className="form-label">Select State:</label>
                <select
                  id="state2"
                  className={`form-select ${styles.customSelect}`}
                  value={selectedState}
                ...
                {!selectedCountry && (
                  <div className={styles.disabledNote}>Please select a country first</div>
                )}
              </div>
