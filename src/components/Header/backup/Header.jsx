...
import { Bell, Search, UserRound, Settings, LogOut, ChevronDown } from "lucide-react";
...
const Header = () => {
  ...
  return (
    <nav className={`${styles.HeaderWrapper} ${styles.topnav} navbar navbar-expand px-3 px-sm-4`}>
      {/* Brand / left side */}
      ...
      {/* Search */}
      <form className={`${styles.searchWrapper} ms-md-3 me-auto d-none d-md-flex`}>
      ...
      {/* Right Actions */}
      <ul className={`${styles.actionsWrapper} navbar-nav ms-auto align-items-center gap-2 gap-sm-3`}>
        ...
        <li className={`${styles.notificationWrapper} nav-item dropdown`}>
          ...
          <div className={`${styles.dropdownMenu} dropdown-menu dropdown-menu-end shadow`}>
            ...
            <div className={styles.tabs}>
              ...
              <button
                className={`${styles.tab} ${activeTab === "msgs" ? styles.active : ""}`}
                onClick={(e) => {
                  e.stopPropagation();
                  setActiveTab("msgs");
                }}
        ...
        <li className={`${styles.profileWrapper} nav-item`} ref={profileRef}>
          ...
          >
            ...
            <ChevronDown size={16} className={`${styles.chevron} ${isProfileOpen ? styles.rotated : ''}`} />
          </button>
          
          <div className={`${styles.profileDropdown} ${isProfileOpen ? styles.show : ''} shadow`}>
            <div className={styles.profileDropdownHeader}>
              <div className={styles.profileInfo}>
                ...
                <div>
                  ...
                  <div className={styles.profileEmail}>driveHub@driveHub.com</div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.profileDropdownMenu}>
              ...
              <a className={`${styles.dropdownItem} ${styles.logoutItem}`} href="#">
                <LogOut size={16} /> 
                <span>Logout</span>
              </a>
            </div>
